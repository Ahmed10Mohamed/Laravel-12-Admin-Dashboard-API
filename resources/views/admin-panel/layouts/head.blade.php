...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr"
    data-theme="theme-default" data-assets-path="https://samionc.com/adminFiles/" data-template="vertical-menu-template"
    data-style="light">
...
<head>
    ...
    <title>{{ translate('Dashboard') }} | {{ translate('Drivo') }}</title>

    <meta name="description" content="{{ translate('Dashboard') }} | {{ translate('Drivo') }}" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="author" content="{{ translate('Drivo') }}" />
    <!-- Favicon -->
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/fonts/flag-icons.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/css/rtl/core.css') }}"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/css/rtl/theme-default.css') }}"
    ...
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/swiper/swiper.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}" />
    <link rel="stylesheet"
        href="{{ asset('adminFiles/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/quill/typography.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/quill/katex.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/quill/editor.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/select2/select2.css') }}" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/dropzone/dropzone.css') }}" />
    ...
    <link rel="stylesheet"
        href="{{ asset('adminFiles/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css') }}" />
    ...
    <link rel="stylesheet"
        href="{{ asset('adminFiles/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/libs/bs-stepper/bs-stepper.css') }}" />


    <!-- Page CSS -->
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/css/pages/cards-advance.css') }}" />
