...
<html
  ...
  <head>
    ...
    <title>لوحة تحكم | نادي بووست الرياضي</title>

    <meta name="description" content="لوحة تحكم | نادي بووست الرياضي" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="author" content="نادي بووست الرياضي" />
    <!-- Favicon -->
    ...
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/css/rtl/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('adminFiles/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css" />
...
<link rel="stylesheet" href="{{asset('adminFiles/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css')}}" />
